...
$userCard = new CreditCard('Ciccio', 'Graziani', 'Francesco', 'Graziani', 1234567891234, '2022-07-03', 333);
$userCard->setExpirationDate('2022-07-03');
$userCard2 = new CreditCard('Paolo', 'Rossi', 'Paolo', 'Rossi', 12345233334, '2022-05-02', 124);
